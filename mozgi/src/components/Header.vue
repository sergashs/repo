			...
			<router-link to="/" class="logo">
				<svg width="85" height="46" viewBox="0 0 85 46" fill="none" xmlns="http://www.w3.org/2000/svg">
					<linearGradient id="lg" x1="0.5" y1="1" x2="0.5" y2="0">
						<stop class="stop" offset="100%" stop-opacity="1" stop-color="#000000">
							<animate attributeName="offset" values="0;1;1" dur="3s" begin="0s" />
						</stop>
						<stop class="stop" offset="0%" stop-opacity="0" stop-color="#000000">
							<animate attributeName="offset" values="0;1;0" dur="3s" begin="0s" />
						</stop>
					</linearGradient>
					<path
						fill="url(#lg)"
