	...
	<div class="container-fluid">
		<div class="row">
			<?php if (have_posts()): ?>
				...
				<?php
				$parent_category_id = get_term_by('slug', 'videos', 'category')->term_id;
				...
				if (($is_home_category && $current_category->slug === 'videos') || !empty($subcategories)) {
					?>
					<div class="mb-2">
					...
					<div>
						<div class="block-border-1 p-1 mb-2">
							...
							if ($is_home_category && $current_category->slug === 'videos') {
