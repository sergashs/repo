	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-8 col-lg-9 informer-row-border">
				<div class="informer-last-news">
					<?php if (have_posts()): ?>
						...
						<?php
						$parent_category_id = get_term_by('slug', 'articles', 'category')->term_id;
						...
						if (($is_home_category && $current_category->slug === 'articles') || !empty($subcategories)) {
							?>
							<div class="mb-2">
							...
							<div>
								<div class="block-border-1 p-1 mb-2">
									...
									if ($is_home_category && $current_category->slug === 'articles') {
			...
			<div class="col-md-4 col-lg-3">
				<div class="mb-2">
					<h3 class="mb-0 pb-0 border-bottom-0 fs-3 pt-1">Найбільше коментують</h3>
